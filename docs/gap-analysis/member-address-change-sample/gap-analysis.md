# Gap analysis — Member Address Change (WORKED EXAMPLE)

| | |
|---|---|
| Requirement source | `Member Address Change` v1.0 (test fixture; same content as the [GAP-TEST] Confluence page) |
| Story source | 2 stories: `[GAP-TEST] Update member mailing address`, `[GAP-TEST] Validate address with USPS before save` |
| Analyzed | 2026-08-20 · by `story-gap-analyst` procedure (validation run) |
...
|---|---|---|---|---|
| CP-1 | FR-1 | S-1 | 1.0 | AC states agent edits address fields on profile |
| CP-2 | FR-1 | S-1 | 1.0 | AC states address saved on member record |
| CP-3 | FR-1 | S-1 | 1.0 | AC states success message |
| CP-4 | FR-2 | S-2 | 1.0 | AC states address sent to USPS on save |
| CP-5 | FR-2 | S-2 | 1.0 | AC states agent can accept standardized address |
| CP-6 | FR-2 | S-2 | 0.0 | Correcting the input not mentioned |
| CP-7 | NFR-3 | S-2 | 0.0 | Supervisor override on USPS outage absent |
| CP-8 | NFR-3 | S-2 | 0.0 | Re-validation flag absent |
| CP-9 | FR-3 | GAP→NEW-1 | 0.0 | No story sends confirmation email |
| CP-10 | FR-3 | GAP→NEW-1 | 0.0 | 15-minute SLA absent |
| CP-11 | BR-1 | S-2 | 0.0 | P.O. Box residential rejection absent |
| CP-12 | BR-1 | S-2 | 0.0 | P.O. Box mailing allowance absent |
...
| CP-17 | NFR-2 | S-1 | 0.0 | Permission restriction absent |
| CP-18 | NFR-2 | S-1 | 0.0 | Read-only for other users absent |

Story scores: S-1 = 3.0/5 = 60% · S-2 = 2.0/7 ≈ 30% · Coverage = 5.0/18 = **28%**
